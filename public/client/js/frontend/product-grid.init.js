...
//     'id': 1,
//     "wishList": false,
//     "productImg": "../client/images/products/img-8.png",
...
//     'id': 2,
//     "wishList": false,
//     "productImg": "../client/images/products/img-15.png",
...
//     'id': 3,
//     "wishList": true,
//     "productImg": "../client/images/products/img-1.png",
...
//     'id': 4,
//     "wishList": false,
//     "productImg": "../client/images/products/img-7.png",
...
//     'id': 5,
//     "wishList": false,
//     "productImg": "../client/images/products/img-4.png",
...
//     'id': 6,
//     "wishList": false,
//     "productImg": "../client/images/products/img-5.png",
...
//     'id': 7,
//     "wishList": false,
//     "productImg": "../client/images/products/img-6.png",
...
//     'id': 8,
//     "wishList": true,
//     "productImg": "../client/images/products/img-9.png",
//     "productTitle": "Lace-Up Casual Shoes For Men",
//     "category": "Kids",
//     "price": "229.00",
//     "discount": "15%",
...
//     'id': 9,
//     "wishList": false,
//     "productImg": "../client/images/products/img-10.png",
...
//     'id': 10,
//     "wishList": false,
//     "productImg": "../client/images/products/img-12.png",
...
//     'id': 11,
//     "wishList": false,
//     "productImg": "../client/images/products/img-3.png",
...
//     'id': 12,
//     "wishList": false,
//     "productImg": "../client/images/products/img-2.png",
            ...
            if (datas[i]) {
                ...
                if (datas[i].color && Array.isArray(datas[i].color)) {
                    ...
                    datas[i].color.slice(0, 3).forEach(function (color, index) {
                        ...
                        colorElem += `
                            <li>
                                <input type="radio" name="color${datas[i].id}" id="${inputId}">
                                <label 
                                    class="avatar-xxs btn p-0 d-flex align-items-center justify-content-center rounded-circle" 
                                    for="${inputId}" 
                                    style="background-color: ${color}; border: 1px solid #ccc;">
                                </label>
                            </li>`;
                    });
                ...
                <div class="card product-widget border-0 card-animate">
                    <div class="card-body p-2">
                        <div class="position-relative p-4 bg-light">
                            <img src="${product.image}" alt="${product.name}" class="img-fluid product-img-main">
                            <ul class="product-menu list-unstyled">
                                <li class="mb-2">
                                    <a href="#!" class="rounded-circle bookmark" data-bs-toggle="button">
                                        <i class="bi bi-star"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="/products/${product.id}" class="rounded-circle">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </li>
                            </ul>
                            <div class="product-btn mx-auto">
                                <a href="/cart" class="btn btn-warning w-100">
                                    <i class="bi bi-bag align-baseline me-1"></i> Buy Now
                                </a>
                            </div>
                        </div>
                        <div class="mt-3">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <span class="text-warning me-2">
                                    ${getStarRating(product.ratings_avg_rating)}
                                </span>
