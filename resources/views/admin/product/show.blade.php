                                    ...
                                    <div class="mt-xl-0 mt-5">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="hstack gap-3 flex-wrap">
                                                    ...
                                                    <div class="vr"></div>
                                                    <div class="text-muted">Người bán : <span
                                        ...
                                        <div class="d-flex flex-wrap gap-2 align-items-center mt-3">
                                            <div class="text-warning fs-5">
                                                @for ($i = 1; $i <= 5; $i++)
                                                    <i
                                                        class="mdi mdi-star{{ $i <= floor($averageRating) ? '' : '-outline' }}"></i>
                                                @endfor
                                            </div>
                                                ...
                                                <div class="p-2 border border-dashed rounded">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <h5 class="mb-0">${{ number_format($product->price, 2) }}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        @foreach ($product->variants->pluck('size')->unique() as $index => $size)
                                                            ...
                                                            <div data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                ...
                                                                <input type="radio" class="btn-check"
                                                                    name="productsize-radio" id="{{ $inputId }}"
                                                                    {{ $stock <= 0 ? 'disabled' : '' }}>
                                                                <label
                                        ...
                                        <div class="product-content mt-5">
                                            ...
                                            <div class="tab-content border border-top-0 p-4" id="nav-tabContent">
                                                        ...
                                                        <table class="table mb-0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $product->variants->pluck('color')->unique()->implode(', ') }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <div class="tab-pane fade" id="nav-detail" role="tabpanel"
                                                    ...
                                                    <div>
                                                        <h5 class="font-size-16 mb-3">Áo len Tommy Hilfiger cho nam (Hồng)
                                                        </h5>
                                                        <p>Áo len nam Tommy Hilfiger màu hồng sọc. Được làm từ chất liệu
                                                            cotton. Thành phần chất liệu là 100% cotton hữu cơ. Đây là một
                                                            trong những thương hiệu phong cách sống hàng đầu thế giới và
                                                            được công nhận quốc tế vì tôn vinh phong cách cổ điển Mỹ, mang
                                                            nét trẻ trung với thiết kế độc đáo.</p>
                                                        <div>
                                                            <p class="mb-2"><i
                                                                    class="mdi mdi-circle-medium me-1 text-muted align-middle"></i>
                                                                Giặt máy</p>
                                                    ...
                                                    <div>
                                                        <div class="pb-3">
                                                            <div class="bg-light px-3 py-2 rounded-2 mb-2">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-shrink-0">
                                                                        <h6 class="mb-0">
                                                                            {{ number_format($averageRating, 1) }} trên 5
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="text-center">
                                                                <div class="text-muted">Tổng cộng <span
                                                                        class="fw-medium">{{ $reviewCount }} đánh
                                                                        giá</span></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        @foreach ([5, 4, 3, 2, 1] as $star)
                                                            ...
                                                            <div class="row align-items-center g-2">
                                                                ...
                                                                <div class="col">
                                                                    <div class="p-2">
                                                                        <div
                                                                            ...
                                                                            <div class="progress-bar bg-{{ $star == 5 ? 'success' : ($star == 4 ? 'info' : ($star == 3 ? 'warning' : 'danger')) }}"
                                                                                role="progressbar"
                                                                                style="width: {{ number_format($percentage, 2) }}%"
                                                                                aria-valuenow="{{ number_format($percentage, 2) }}"
                                                                ...
                                                                <div class="col-auto">
                                                                    <div class="p-2">
                                                                        <h6 class="mb-0 text-muted">{{ $starCount }}
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                            </div>
