                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="product-title-input" name="name"
                                        value="{{ old('name') }}" placeholder="Enter product title" required>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control" id="ckeditor-classic" name="description" rows="5">{{ old('description', 'Enter product description...') }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <p class="text-muted">Add the product's main image.</p>
