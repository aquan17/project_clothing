                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted mb-0">Color: <span class="fw-medium">{{ $item->productVariant->color }}</span></p>
                                                        <p class="text-muted mb-0">Size: <span class="fw-medium">{{ $item->productVariant->size }}</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <td colspan="2" class="fw-medium p-0">
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    ...
                                                    @if($discount > 0)
                                                        <tr>
                                                            <td>Discount <span class="text-muted">({{ $order->coupon->code ?? 'No Code' }}) :</span></td>
