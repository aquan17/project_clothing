<div class="header">
    ...
    <img src="{{ asset('admin/img/flags/us1.png') }}" alt="" height="16"> English
    </a>
    <a href="javascript:void(0);" class="dropdown-item">
    ...
    <form action="{{ route('logout') }}" method="POST">
        ...
        <button class="dropdown-item logout pb-0" href="{{route('logout')}}"><img src="{{ asset('admin/img/icons/log-out.svg') }}" class="me-2" alt="img">Logout</button>
    </form>
    ...
    <a class="dropdown-item" href="adad ">Logout</a>
    </div>
    </div>
