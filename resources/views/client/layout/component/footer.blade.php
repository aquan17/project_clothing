    ...
    <div class="container">
        <div class="row align-items-center pt-35px pb-35px">
            ...
            <div class="col-12 col-md-auto sm-mb-15px text-center text-md-start"> 
                <a href="demo-fashion-store.html" class="footer-logo"><img src="{{ asset('client/images/demo-fashion-store-logo-white@2x.png')}}" data-at2x="{{ asset('client/images/demo-fashion-store-logo-white@2x.png')}}" alt="" class="default-logo"></a>
            </div>
            <!-- end footer column -->
            <!-- start footer column -->
            <div class="col"> 
        ...
        <div class="row justify-content-center fs-15 lh-28 pb-50px xs-pb-35px">
            ...
            <div class="col-6 col-lg-3 col-md-4 col-sm-5 md-mb-50px xs-mb-30px order-sm-2 order-lg-2 offset-md-2 offset-lg-0">
                ...
                <div class="mb-15px"><i class="feather icon-feather-mail fs-16 text-white me-10px xs-me-5px"></i><a href="/cdn-cgi/l/email-protection#f79e999198b793989a969e99d994989a" class="text-decoration-line-bottom"><span class="__cf_email__" data-cfemail="dbb2b5bdb49bbfb4b6bab2b5f5b8b4b6">[email&#160;protected]</span></a></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-7 ps-20px sm-ps-15px md-mb-50px xs-mb-0 order-sm-1 order-lg-5">
                ...
                <div class="footer-card">
                    <a href="#" class="d-inline-block me-5px align-middle"><img src="{{ asset('client/images/demo-decor-store-payment-icon-01.png')}}" alt=""></a>
                    <a href="#" class="d-inline-block me-5px align-middle"><img src="{{ asset('client/images/demo-decor-store-payment-icon-02.png')}}" alt=""></a>
                    <a href="#" class="d-inline-block me-5px align-middle"><img src="{{ asset('client/images/demo-decor-store-payment-icon-03.png')}}" alt=""></a>
                    <a href="#" class="d-inline-block me-5px align-middle"><img src="{{ asset('client/images/demo-decor-store-payment-icon-04.png')}}" alt=""></a>
                </div>
            </div>
            <!-- end footer column -->                        
        </div> 
