            ...
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li class="{{ request()->routeIs('products.index') ? 'active-menu' : '' }}">
                            <a href="{{ route('products.index')}}">Sản Phẩm</a>
                        </li>

                        <li class="{{ request()->routeIs('cart') ? 'active-menu' : '' }}">
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <a href="#" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
                        <img src="{{ asset('assets/images/user.png') }}" alt="" style="margin-bottom: 5px">
                    </a>
                </div>
