...
@section('content')
                                    ...
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2" name="color">
                                            ...
                                            @foreach ($variants as $variant)
                                                <option value="" style="color: {{ $variant->hex_code }}">
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    <div class="p-b-30 m-lr-15-sm">
                                                ...
                                                <div class="size-207">
                                                    <div class="flex-w flex-sb-m p-b-17">
                                                        <span class="mtext-107 cl2 p-r-20">
                                                            @if ($comment->customer)
                                                                {{ $comment->customer->name }} <!-- Tên khách hàng -->
                                                            @else
                                                                Unknown Customer
                                                            @endif
                                                        </span>
                                                        ...
                                                        <span class="fs-18 cl11">
                                                            @for ($i = 1; $i <= 5; $i++)
                                                                @if ($i <= floor($averageRating))
                                                                    <i class="zmdi zmdi-star"></i> <!-- Đầy sao -->
                                                                @elseif($i == ceil($averageRating) && $averageRating - floor($averageRating) >= 0.5)
                                                                    <i class="zmdi zmdi-star-half"></i> <!-- Sao nửa -->
                                                                @else
                                                    ...
                                                    <p class="stext-102 cl6">
                                                        {{ $comment->content }} <!-- Nội dung của comment -->
                                                    </p>
                                                </div>
                                            </div>
                                        @endforeach
                                        ...
                                        <!-- Add review -->
                                            <form class="w-full" action="{{ route('product.review', $product->id) }}" method="POST">
                                                @csrf
    ...
    <section class="sec-relate-product bg0 p-t-20  p-b-105">
        <div class="container">
            <div class="p-b-45">
                <h3 class="ltext-106 txt-center" style="font-family: 'Roboto', sans-serif; font-weight: 500" >
                    Sản phẩm liên quan
                </h3>
            </div>
                        ...
                        <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                            ...
                            <div class="block2">
                                <div class="block2-pic hov-img0">
                                    <img src="{{ asset( $relatedProduct->image) }}" alt="IMG-PRODUCT">
                                ...
                                <div class="block2-txt flex-w flex-t p-t-14">
                                    <div class="block2-txt-child1 flex-col-l">
                                        <a href="{{ route('products.show', $relatedProduct->id) }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                            {{ $relatedProduct->name }}
                                        </a>
        
                                        <span class="stext-105 cl3">
                                            {{ number_format($relatedProduct->price, 3) }} VND
                                        </span>
                                    </div>
