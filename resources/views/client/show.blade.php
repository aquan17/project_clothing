...
@section('content')
    ...
    <div id="notification" style="display: none; padding: 10px; margin: 5px 150px; border-radius: 5px; "></div>
                    ...
                    <div class="row overflow-hidden position-relative">
                        <div class="col-12 col-lg-10 position-relative order-lg-2 product-image ps-30px md-ps-15px">
                            <div class="swiper product-image-slider"
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <!-- end slider item -->
                                    <div class="swiper-slide gallery-box">
                                        <a href="images/demo-fashion-store-product-detail-03.jpg"
                                    ...
                                    <!-- end slider item -->
                                    <div class="swiper-slide gallery-box">
                                        <a href="images/demo-fashion-store-product-detail-04.jpg"
                                            data-group="lightbox-gallery" title="Relaxed corduroy shirt">
                                            <img class="w-100" src="{{ asset($product->image) }}" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <!-- end slider item -->
                                    <div class="swiper-slide gallery-box">
                                        <a href="images/demo-fashion-store-product-detail-05.jpg"
                                            data-group="lightbox-gallery" title="Relaxed corduroy shirt">
                                            <img class="w-100" src="{{ asset($product->image) }}" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <!-- end slider item -->
                                    <div class="swiper-slide gallery-box">
                                        <a href="images/demo-fashion-store-product-detail-06.jpg"
                                            data-group="lightbox-gallery" title="Relaxed corduroy shirt">
                                            <img class="w-100" src="{{ asset($product->image) }}" alt="">
                                        </a>
                                    </div>
                        ...
                        <div class="col-12 col-lg-2 order-lg-1 position-relative single-product-thumb">
                            <div class="swiper-container product-image-thumb slider-vertical">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img class="w-100" src="{{ asset($product->image) }}"
                                            alt=""></div>
                                    <div class="swiper-slide"><img class="w-100" src="{{ asset($product->image) }}"
                                            alt=""></div>
                                    <div class="swiper-slide"><img class="w-100" src="{{ asset($product->image) }}"
                    ...
                    <h4 class="alt-font text-dark-gray fw-500 mb-5px">{{ $product->name }}</h5>
                        <div class="d-block d-sm-flex align-items-center mb-15px">
                            <div class="me-10px xs-me-0">
                                @for ($i = 1; $i <= 5; $i++)
                                    <i class="bi bi-star-fill {{ $i <= $product->rating ? 'text-golden-yellow' : '' }}"></i>
                                @endfor
                            </div>
                        ...
                        <div class="product-price mb-10px">
                            <span class="text-dark-gray fs-28 xs-fs-24 fw-700 ls-minus-1px">{{ $product->price }}
                                VND</span>
                        </div>
                        <p>{{ $product->description }}</p>
                            ...
                            <div class="d-flex align-items-center mb-20px">
                                ...
                                <ul class="shop-color mb-0">
                                    @foreach ($product->variants->pluck('color')->unique() as $index => $color)
                                        <li>
                                            <input class="d-none" type="radio" id="color-{{ $index + 1 }}"
                                                name="color" value="{{ $color }}"
                                                {{ $index === 0 ? 'checked' : '' }}>
                                            <label for="color-{{ $index + 1 }}"><span
                            ...
                            <div class="d-flex align-items-center mb-35px">
                                ...
                                <ul class="shop-size mb-0">
                                    @foreach ($product->variants->pluck('size')->unique() as $index => $size)
                                        <li>
                                            <input class="d-none" type="radio" id="size-{{ $index + 1 }}"
                                                name="size" value="{{ $size }}"
                                                {{ $index === 0 ? 'checked' : '' }}>
                                            <label
                                                for="size-{{ $index + 1 }}"><span>{{ $size }}</span></label>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <div class="d-flex align-items-center flex-column flex-sm-row mb-20px position-relative">
                                <div class="quantity me-15px xs-mb-15px order-1">
                                    ...
                                    <input class="qty-text" type="text" name="quantity" value="1"
                        ...
                        <div class="row mb-15px">
                            <div class="col-12 icon-with-text-style-08">
                                <div class="feature-box feature-box-left-icon d-inline-flex align-middle">
                                    ...
                                    <div class="feature-box-content">
                                        <span><span class="alt-font text-dark-gray fw-500">Estimated delivery:</span> March
                                            03 - March 07</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 icon-with-text-style-08 mb-10px">
                                <div class="feature-box feature-box-left-icon d-inline-flex align-middle">
                                    ...
                                    <div class="feature-box-content">
                                        <span><span class="alt-font text-dark-gray fw-500">Free shipping & returns:</span>
                        ...
                        <div
                            ...
                            <div>
                                <a href="#"><img src="images/visa.svg" class="h-30px me-5px mb-5px"
                                        alt=""></a>
                                <a href="#"><img src="images/mastercard.svg" class="h-30px me-5px mb-5px"
                                        alt=""></a>
                                <a href="#"><img src="images/american-express.svg" class="h-30px me-5px mb-5px"
                                        alt=""></a>
                                <a href="#"><img src="images/discover.svg" class="h-30px me-5px mb-5px"
                                        alt=""></a>
                                <a href="#"><img src="images/diners-club.svg" class="h-30px me-5px mb-5px"
                                        alt=""></a>
                        ...
                        <div>
                            ...
                            <div><span class="text-dark-gray alt-font fw-500">Tags: </span><a href="#">Shirts,</a>
                                <a href="#">Cotton,</a> <a href="#">Printed</a></div>
                        </div>
                </div>
            </div>
        </form>
                ...
                <div class="col-12 tab-style-04">
                    <ul class="nav nav-tabs border-0 justify-content-center alt-font fs-19">
                        <li class="nav-item"><a data-bs-toggle="tab" href="#tab_five1"
                                class="nav-link active">Description<span class="tab-border bg-dark-gray"></span></a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab_five4"
                                data-tab="review-tab">Reviews ({{ $reviewCount }})<span
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active show" id="tab_five1">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-lg-6 md-mb-40px">
                                    ...
                                    <div>
                                        <div class="feature-box feature-box-left-icon-middle mb-10px">
                                            ...
                                            <div class="feature-box-content">
                                                <span class="d-block text-dark-gray fw-500">Made from soft yet durable 100%
                                                    organic cotton twill.</span>
                                            </div>
                                        </div>
                                        <div class="feature-box feature-box-left-icon-middle mb-10px">
                                            <div
                                            ...
                                            <div class="feature-box-content">
                                                <span class="d-block text-dark-gray fw-500">Front and back yoke seams allow
                                                    a full range of shoulder.</span>
                                            </div>
                                        </div>
                                        <div class="feature-box feature-box-left-icon-middle mb-10px">
                                            <div
                                            ...
                                            <div class="feature-box-content">
                                                <span class="d-block text-dark-gray fw-500">Interior storm flap and zipper
                                                    garage at chin for comfort.</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-8">
                                    <img src="images/demo-fashion-store-product-detail-07.jpg" alt=""
                                        class="w-100" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div
                                            class="col-lg-2 col-md-3 col-sm-4 pt-10px pb-10px xs-pb-0 text-dark-gray alt-font fw-500">
                                            Free shipping:</div>
                                        <div class="col-lg-10 col-md-9 col-sm-8 pt-10px pb-10px xs-pt-0">On all orders over
                                            $50</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade in" id="tab_five4">
                            ...
                            <div class="row align-items-center mb-6 sm-mb-10">
                                <div class="col-lg-4 col-md-12 col-sm-7 md-mb-30px text-center text-lg-start">
                                    <h5 class="alt-font text-dark-gray fw-500 mb-0 w-85 lg-w-100">
                                        <span class="fw-600">{{ number_format($reviewCount) }}+</span> người đã đánh giá
                                        sản phẩm này.
                                    </h5>
                                </div>
                                <div class="col-lg-2 col-md-4 col-sm-5 text-center sm-mb-20px p-0 md-ps-15px md-pe-15px">
                                    <div class="border-radius-4px bg-very-light-gray p-30px xl-p-20px">
                                        <h2 class="mb-5px alt-font text-dark-gray fw-600">{{ round($averageRating, 1) }}
                                        </h2>
                                        ...
                                        @for ($i = 5; $i >= 1; $i--)
                                            <div class="progress mb-20px border-radius-6px">
                                                <div class="progress-bar bg-green m-0" role="progressbar"
                                                    ...
                                                    aria-valuemax="100" aria-label="rating"
                                                    style="width: {{ $ratingPercentages[$i] }}%"></div>
                                            </div>
                                        @endfor
                                    </div>
                                </div>
                                <div class="col-3 col-lg-2 col-md-3 col-sm-4 mt-45px">
                                    @for ($i = 5; $i >= 1; $i--)
                                        <div class="mb-15px lh-0 xs-lh-normal xs-mb-10px">
                                            ...
                                            <span
                                                class="fs-13 text-dark-gray fw-600 ms-10px xs-ms-0">{{ $ratingPercentages[$i] }}%</span>
                                        </div>
                                    @endfor
                                </div>
                            </div>
                            ...
                            <!-- Comments List -->
                            <div id="comments" class="row g-0 mb-4 md-mb-35px">
                                    ...
                                    <div
                                        ...
                                        <div class="d-block d-md-flex w-100 align-items-center">
                                            <div class="w-300px md-w-250px sm-w-100 sm-mb-10px text-center">
                                                <img src="{{ $comment->customer && $comment->customer->avatar ? asset($comment->customer->avatar) : asset('images/default-avatar.jpg') }}"
                                                    class="rounded-circle w-90px mb-10px" alt="">
                                                <span
                                                    class="text-dark-gray fw-600 d-block">{{ $comment->customer->name ?? 'Ẩn danh' }}</span>
                                            ...
                                            <div
                                                ...
                                                <span
                                                    ...
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <i
                                                            class="bi bi-star{{ $i <= ($comment->rating ?? 0) ? '-fill' : '' }}"></i>
                                                    @endfor
                                                </span>
                                                <a href="#"
                                                    ...
                                                    <i
                                                        class="fa-solid fa-heart text-red me-5px"></i><span>{{ $comment->likes ?? 0 }}</span>
                                                </a>
                                ...
                                <div class="col-12">
                                    <div class="p-7 lg-p-5 sm-p-7 bg-very-light-gray">
                                        @auth
                                            ...
                                            <form action="{{ route('product.review', $product->id) }}#comments"
                                                ...
                                                <div class="col-lg-2 mb-20px">
                                                    ...
                                                    <div class="star-rating mt-20px md-mt-0">
                                                        @for ($i = 5; $i >= 1; $i--)
                                                            ...
                                                            <label for="rating-{{ $i }}"
                                                                class="text-golden-yellow fs-15 ls-minus-1px"><i
                                                                    class="bi bi-star{{ old('rating') >= $i ? '-fill' : '' }}"></i></label>
                                                        @endfor
                                                        @error('rating')
                                                ...
                                                <div class="col-md-10 mb-20px">
                                                    <label class="form-label mb-15px">Bình luận của bạn*</label>
                                                    <textarea class="border-radius-4px form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" cols="40"
                                                        rows="4" name="content" placeholder="Nhập bình luận của bạn">{{ old('content') }}</textarea>
                                                    @error('content')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-lg-3 text-start text-lg-end">
                                                    <button class="btn btn-dark-gray btn-small btn-box-shadow btn-round-edge"
                            ...
                            <!-- JavaScript cuộn mượt đến phần bình luận -->
                            <script>
